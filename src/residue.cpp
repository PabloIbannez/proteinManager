...
namespace proteinManager {
    ...
    STRUCTURE& RESIDUE::getParentStructure() const {
        return this->getParentChain().getParentStructure();
    }

    MODEL& RESIDUE::getParentModel() const {
        return this->getParentChain().getParentModel();
    }
